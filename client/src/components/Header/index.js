...
function Header() {
  return (
    <div className="hero-container">
      ...
      <div>
      <img className= "cupcakeimg" src={Cupcakes} style={{ width: '600px', float: 'left', marginLeft: '200px', paddingTop: '300px' }} alt="logo"/>

      

      <img className="aboutuslogo" src={Aboutuslogo} style={{ width: '300px', height: '300px', marginTop: '183px', marginLeft: '340px' }} alt="logo"/>
